...
if [ "$DB_SCHEME" = "mysql" ]; then
  echo "Detected MySQL connection string. start-database.sh assumes Postgres and will not manage MySQL containers."
  echo "Make sure your local MySQL server (mercato_dev) is running and accessible."
  exit 0
fi
